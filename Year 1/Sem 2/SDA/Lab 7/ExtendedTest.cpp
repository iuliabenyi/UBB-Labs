...
void testAllExtended() {
	...
	cout << "Test create passed!"<<endl;
	testAdd();
	cout << "Test add passed!" << endl;
	testRemove(rLessEqual);
	cout << "Test remove 1 passed!" << endl;
	testRemove(rGreater);
	cout << "Test remove 2 passed!" << endl;
	testIterator(rLessEqual);
	cout << "Test iterator 1 passed!" << endl;
	testIterator(rGreater);
	cout << "Test iterator 2 passed!" << endl;
	testQuantity(rLessEqual);
	cout << "Test quantity 1 passed!" << endl;
	testQuantity(rGreater);
	cout << "Test quantity 2 passed!" << endl;
