...
namespace ASPLogin.DataAbstractionLayer
{
    public class DAL
    {
        ...
        public List<Websites> GetWebsites()
        {
            ...
            List<Websites> webList = new List<Websites>();
            ...
            try
            {
                ...
                while (dataReader.Read())
                {
                    ...
                    web.id = dataReader.GetInt32("id");
                    web.url = dataReader.GetString("url");
                    webList.Add(web);
                }
        ...
        public void UpdateDoc(int id, string keyword1, string keyword2, string keyword3, string keyword4, string keyword5)
        {
            MySqlConnection connection;
            string connectionString;
            ...
            try
            {
                ...
                MySqlCommand cmd = new MySqlCommand();
                cmd.Connection = connection;
                cmd.CommandText = "UPDATE documents SET keyword1 = '" + keyword1 + "', keyword2 = '" + keyword2 + "', keyword3 = '" + keyword3 + "', keyword4 = '" + keyword4 + "', keyword5 = '" + keyword5 + "' WHERE id = " + id + " ";
